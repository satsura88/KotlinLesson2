package com.example.kotlinlesson2.view.contentprovider
...
import com.example.kotlinlesson2.databinding.FragmentContentProviderBinding
    ...
    private fun checkPermission(){
        ...
        if (permResult == PackageManager.PERMISSION_GRANTED) {
            ...
            AlertDialog.Builder(requireContext())
                ...
                .setMessage("Ну вот прям очень надо))))")
